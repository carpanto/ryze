// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Brand.cs" company="SurvivorSeriesAIO">
...
namespace SurvivorSeriesAIO.Champions
{
    internal class Brand : ChampionBase
    {
        ...
        {
            if (!Config.QGapC.GetValue<bool>() || (Player.Mana < Q.Instance.ManaCost + E.Instance.ManaCost))
                return;
        ...
        {
            if (!Config.InterruptEQ.GetValue<bool>() || (Player.Mana < Q.Instance.ManaCost + E.Instance.ManaCost))
                return;
